with open("/home/skilleton4ik/Видео/weather_station/esp01_build/src/DisplayManager.cpp", "w", encoding="utf-8") as f:
    f.write("""#include "DisplayManager.h"
#include <Wire.h>
#include "config.h"
#include <math.h>
...
static const uint8_t PROGMEM ICO_CLEAR[] = {
    0x00,0xE0,0xF0,0xF8,0xFA,0xFD,0xF9,0xFE, 0xFC,0xF8,0xF8,0xF0,0xE0,0x00,0x00,0x00, 
    0x00,0x03,0x07,0x0F,0x2F,0x5F,0x4F,0x3F, 0x1F,0x0F,0x0F,0x07,0x03,0x00,0x00,0x00
};

static const uint8_t PROGMEM ICO_MOON[] = {
    0xE0,0xF8,0xFC,0xFE,0xFE,0x1F,0x0F,0x07, 0x03,0x00,0x00,0x00,0x00,0x00,0x00,0x00, 
    0x01,0x07,0x0F,0x1F,0x3F,0x3E,0x7C,0x78, 0x70,0x00,0x00,0x00,0x00,0x00,0x00,0x00
};

static const uint8_t PROGMEM ICO_PARTLY[] = {
    0x00,0x00,0x00,0x0C,0x9E,0xB9,0xB9,0xBE, 0xFC,0xF8,0xF0,0xE0,0xE0,0xC0,0x80,0x00, 
    0x00,0x06,0x0F,0x1F,0x1F,0x1F,0x1F,0x1F, 0x1F,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F
};

static const uint8_t PROGMEM ICO_CLOUD[] = {
    0xE0,0xF0,0xF8,0xFC,0xFE,0xFE,0xFE,0xFE, 0xFC,0xF8,0xF0,0xE0,0x00,0x00,0x00,0x00, 
    0x03,0x07,0x07,0x07,0x07,0x07,0x07,0x07, 0x07,0x07,0x07,0x03,0x00,0x00,0x00,0x00
};

static const uint8_t PROGMEM ICO_RAIN[] = {
    0xE0,0xF0,0xF8,0xFC,0xFE,0xFE,0xFE,0xFE, 0xFC,0xF8,0xF0,0xE0,0x00,0x00,0x00,0x00, 
    0x00,0x45,0x11,0x45,0x11,0x45,0x11,0x45, 0x11,0x45,0x11,0x44,0x00,0x00,0x00,0x00
};

static const uint8_t PROGMEM ICO_SNOW[] = {
    0x60,0xF0,0xF8,0xFC,0xFE,0xFE,0xFE,0xFE, 0xFC,0xF8,0xF0,0x60,0x00,0x00,0x00,0x00, 
    0x08,0x08,0x2A,0x1C,0x1C,0x2A,0x08,0x1C, 0x2A,0x1C,0x1C,0x2A,0x00,0x00,0x00,0x00
};

static const uint8_t PROGMEM ICO_STORM[] = {
    0xF0,0xF0,0xF8,0xFC,0xFE,0xFE,0xFE,0xFE, 0xFC,0xF8,0xF0,0xF0,0x00,0x00,0x00,0x00, 
    0x00,0x11,0x39,0x7D,0x7F,0x6F,0x47,0x03, 0x01,0x01,0x01,0x00,0x00,0x00,0x00,0x00
};

static const uint8_t PROGMEM ICO_FOG[] = {
    0x54,0x54,0x54,0x54,0x54,0x54,0x54,0x54, 0x54,0x54,0x54,0x54,0x00,0x00,0x00,0x00, 
...
void DisplayManager::drawRetroFactory(const WeatherData& data, struct tm* ti, bool isNight, const String& lang) {
    ...
    if (cycle == 0) {
        ...
        _oled.setScale(1);
        char statsBuf[32];
        snprintf(statsBuf, sizeof(statsBuf), "%.0fC | %.0f%% | %.0fhPa", data.temperature, data.humidity, data.pressure);
